<!-- Appended to the system prompt only for a Claude Code profile. A coding CLI arrives believing it
     may reach the host computer, so the tool boundary has to be stated in its own vocabulary. -->
